...
namespace Vic.CSharp.Week3.AlexGao
{
    class DiscountCalculator
    {
        ...
        public decimal Calculate(decimal money)
        {
            ...
            if (money < 0) { return 0; }
                ...
                if (money < 100) { return money; }
            else
                if (money >= 100 && money < 500) { return money * Nine; }
            else
                if (money >= 500 && money < 1000) { return money * Eight; }
            else
                if (money >= 1000) { return money - 200; }
            else
                return 0;
        }
    }
